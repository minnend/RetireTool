...
public class RetireTool
{
  ...
  public static void runSweep(File dir) throws IOException
  {
    ...
    final int[] margins = new int[] { 25, 100, 200, 500 };
  ...
  public static void runJitterTest(File dir) throws IOException
  {
    ...
    PredictorConfig[] singleConfigs = new PredictorConfig[] { new ConfigSMA(20, 0, 240, 150, 25, FinLib.Close, gap),
        new ConfigSMA(25, 0, 155, 125, 75, FinLib.Close, gap), new ConfigSMA(5, 0, 165, 5, 50, FinLib.Close, gap) };
  ...
  {
    PredictorConfig[] singleConfigs = new PredictorConfig[] { new ConfigSMA(20, 0, 240, 150, 25, FinLib.Close, gap),
        new ConfigSMA(20, 0, 250, 50, 100, FinLib.Close, gap), new ConfigSMA(50, 0, 180, 30, 100, FinLib.Close, gap),
        new ConfigSMA(10, 0, 220, 0, 200, FinLib.Close, gap), new ConfigSMA(10, 0, 230, 40, 200, FinLib.Close, gap), };
  ...
  public static void runOne(File dir) throws IOException
  {
    ...
    PredictorConfig[] configs = new PredictorConfig[] { new ConfigSMA(20, 0, 240, 150, 25, FinLib.Close, gap),
        new ConfigSMA(50, 0, 180, 30, 100, FinLib.Close, gap), new ConfigSMA(10, 0, 220, 0, 200, FinLib.Close, gap), };
  ...
  public static List<ConfigSMA> loadSMAList(File file) throws IOException
  {
    ...
    while ((line = reader.readLine()) != null) {
      ...
      int margin = (int) Math.round(Double.parseDouble(m.group(5)) * 100.0);
