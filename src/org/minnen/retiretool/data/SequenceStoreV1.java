 ...
 * @author David Minnen
 */
public class SequenceStoreV1 extends SequenceStore
{
  ...
  public SequenceStoreV1()
  {
    this(1.0);
  }

  public SequenceStoreV1(double startValue)
  {
  ...
  public void recalcDurationalStats(int nMonths, FinLib.Inflation inflation)
  {
    ...
    for (int i = 0; i < nominalReturns.size(); ++i) {
      Sequence returns = (inflation == FinLib.Inflation.Nominal ? nominalReturns.get(i) : realReturns.get(i));
