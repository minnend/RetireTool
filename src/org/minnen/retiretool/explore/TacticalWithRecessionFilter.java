...
public class TacticalWithRecessionFilter
{
  ...
  public static void main(String[] args) throws IOException
  {
    ...
    Chart.saveLineChart(new File(DataIO.getOutputPath(), "unrate.html"), "Unemployment Rate", "100%", "640px", ChartScaling.LINEAR,
    ...
    ChartConfig chartConfig = Chart.saveLineChart(new File(DataIO.getOutputPath(), "returns.html"), null, "100%", "640px",
